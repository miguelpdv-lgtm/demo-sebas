...
const timelineData: TimelineItem[] = [
  {
    ...
    date: "01",
    content: "Diseñamos infraestructuras escalables, resilientes y preparadas para alto tráfico utilizando los mejores proveedores de la nube.",
  ...
  },
  {
    ...
    date: "02",
    content: "APIs robustas y microservicios que orquestan tus procesos de negocio con latencia mínima y máxima seguridad.",
    category: "Desarrollo",
    icon: Server,
    relatedIds: [1, 3],
    status: "completed",
  ...
  },
  {
    ...
    date: "03",
    content: "Pipelines de datos e integración de bases de datos distribuidas para que tu información fluya en tiempo real.",
    category: "Datos",
    icon: Database,
    relatedIds: [2, 4],
    status: "in-progress",
  ...
  },
  {
    ...
    date: "04",
    content: "Auditorías continuas, encriptación end-to-end y protocolos de seguridad que protegen tu activo más valioso.",
    category: "Seguridad",
    icon: Lock,
    relatedIds: [3, 5],
    status: "pending",
  ...
  },
  {
    ...
    title: "Agentes IA",
    date: "05",
    content: "Automatización de procesos mediante agentes de inteligencia artificial que aprenden y optimizan tus operaciones.",
    category: "Innovación",
    icon: Cpu,
    relatedIds: [1, 4],
    status: "pending",
